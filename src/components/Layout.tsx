...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-parchment-dark flex flex-col">
      ...
      {/* Header */}
      <header className={`sticky ${needRefresh ? 'top-[52px]' : 'top-0'} z-40 bg-gradient-to-br from-parchment to-parchment-light border-b-2 border-border-subtle shadow-[0_4px_12px_var(--shadow-color)] transition-[top] duration-200 pt-safe`}>
